...
CREATE ROLE administrador WITH LOGIN PASSWORD 'SENHA_ADMIN';
CREATE ROLE aplicacao_web WITH LOGIN PASSWORD 'SENHA_APP';
CREATE ROLE extracao_relatorios WITH LOGIN PASSWORD 'SENHA_REL';
